...
const realTimeTask = new Task(
    ...
    async () => {
        ...
        const totalScores = {};
        const aDayAgo = new Date(new Date().setDate(new Date().getDate() - 2));
        ...
        // const totalScoresArray = Object.keys(totalScores).map((key) => { { PostId: parseInt(key, 10), Score: totalScores[key] }})
